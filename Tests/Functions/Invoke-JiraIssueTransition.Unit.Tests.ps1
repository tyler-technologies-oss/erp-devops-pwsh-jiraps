...
Describe "Invoke-JiraIssueTransition" -Tag 'Unit' {
    ...
    InModuleScope Tyler.DevOps.JiraPS {
        ...
        Mock Get-JiraIssue -ModuleName Tyler.DevOps.JiraPS {
            ...
            $t1.PSObject.TypeNames.Insert(0, 'Tyler.DevOps.JiraPS.Transition')
            $t2 = [PSCustomObject] @{
                Name = 'Resolve'
                ID   = 81
            }
            $t2.PSObject.TypeNames.Insert(0, 'Tyler.DevOps.JiraPS.Transition')
        ...
        Mock Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -ParameterFilter {$Method -eq 'Post' -and $URI -eq "$jiraServer/rest/api/2/issue/$issueID/transitions"} {
        ...
        It "Updates custom fields if provided to the -Fields parameter" {
            ...
            Assert-MockCalled -CommandName Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -Times 1 -Scope It -ParameterFilter { $Method -eq 'Post' -and $URI -like "*/rest/api/2/issue/$issueID/transitions" -and $Body -like '*customfield_12345*set*foo*' }
            Assert-MockCalled -CommandName Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -Times 1 -Scope It -ParameterFilter { $Method -eq 'Post' -and $URI -like "*/rest/api/2/issue/$issueID/transitions" -and $Body -like '*customfield_67890*set*bar*' }
        }
        ...
        It "Updates assignee name if provided to the -Assignee parameter" {
            ...
            Assert-MockCalled -CommandName Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -Times 1 -Scope It -ParameterFilter { $Method -eq 'Post' -and $URI -like "*/rest/api/2/issue/$issueID/transitions" -and $Body -like '*name*powershell-user*' }
        }
        ...
        It "Unassigns an issue if 'Unassigned' is passed to the -Assignee parameter" {
            ...
            Assert-MockCalled -CommandName Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -Times 1 -Scope It -ParameterFilter { $Method -eq 'Post' -and $URI -like "*/rest/api/2/issue/$issueID/transitions" -and $Body -like '*name*""*' }
        }
        ...
        It "Adds a comment if provide to the -Comment parameter" {
            ...
            Assert-MockCalled -CommandName Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -Times 1 -Scope It -ParameterFilter { $Method -eq 'Post' -and $URI -like "*/rest/api/2/issue/$issueID/transitions" -and $Body -like '*body*test comment*' }
        }
        ...
        It "Returns the Issue object when -Passthru is provided" {
            ...
            Assert-MockCalled -CommandName Get-JiraIssue -ModuleName Tyler.DevOps.JiraPS -Exactly -Times 4 -Scope It
        }
