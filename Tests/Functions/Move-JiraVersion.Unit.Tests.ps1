...
"@
        ...
        Mock Get-JiraProject -ModuleName Tyler.DevOps.JiraPS {
            ...
            $Projects.PSObject.TypeNames.Insert(0, 'Tyler.DevOps.JiraPS.Project')
            $Projects | Where-Object {$_.Key -in $Project}
        }

        Mock Get-JiraVersion -ModuleName Tyler.DevOps.JiraPS {
            foreach ($_id in $Id) {
                ...
                $Version.PSObject.TypeNames.Insert(0, 'Tyler.DevOps.JiraPS.Version')
                $Version
            }
        }

        Mock Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -ParameterFilter { $Method -eq 'POST' -and $URI -like "$jiraServer/rest/api/*/version/$versionID1/move" } {
            ShowMockInfo 'Invoke-JiraMethod' 'Method', 'Uri'
        }

        Mock Invoke-JiraMethod -ModuleName Tyler.DevOps.JiraPS -ParameterFilter { $Method -eq 'POST' -and $URI -like "$jiraServer/rest/api/*/version/$versionID2/move" } {
            ShowMockInfo 'Invoke-JiraMethod' 'Method', 'Uri'
        }
        ...
        Context "ByPosition behavior checking" {
            It 'moves a Version using its ID and Last Position' {
                ...
                Assert-MockCalled 'Get-JiraVersion' -Times 0 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Get-JiraConfigServer' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Invoke-JiraMethod' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly -ParameterFilter {
                    $Method -eq 'POST' -and
            ...
            It 'moves a Version using a Tyler.DevOps.JiraPS.Version object and Later Position' {
                {
                    $version = Get-JiraVersion -ID $versionID2
                    Move-JiraVersion -Version $version -Position Later -ErrorAction Stop
                } | Should Not Throw
                Assert-MockCalled 'Get-JiraVersion' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Get-JiraConfigServer' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Invoke-JiraMethod' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly -ParameterFilter {
                    $Method -eq 'POST' -and
            ...
            It 'moves a Version using Tyler.DevOps.JiraPS.Version object and First Position' {
                {
                    $version = Get-JiraVersion -ID $versionID2
            ...
            It 'moves a Version using Tyler.DevOps.JiraPS.Version object over pipeline and First Position' {
                {
                    $version = Get-JiraVersion -ID $versionID2
        ...
        Context "ByAfter behavior checking" {
            It 'moves a Version using its ID and other Version ID' {
                ...
                Assert-MockCalled 'Get-JiraVersion' -Times 2 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Get-JiraConfigServer' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Invoke-JiraMethod' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly -ParameterFilter {
                    $Method -eq 'POST' -and
                    $URI -like "$jiraServer/rest/api/2/version/$versionID1/move" -and
            ...
            It 'moves a Version using Tyler.DevOps.JiraPS.Version object and other Version ID' {
                $restUrl = (Get-JiraVersion -Id $versionID2).RestUrl
                ...
                Assert-MockCalled 'Get-JiraVersion' -Times 3 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Get-JiraConfigServer' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly
                Assert-MockCalled 'Invoke-JiraMethod' -Times 1 -Scope It -ModuleName Tyler.DevOps.JiraPS -Exactly -ParameterFilter {
                    $Method -eq 'POST' -and
                    $URI -like "$jiraServer/rest/api/2/version/$versionID1/move" -and
            ...
            It 'moves a Version using its ID and other Version Tyler.DevOps.JiraPS.Version object' {
            ...
            It 'moves a Version using its ID over pipeline and other Version Tyler.DevOps.JiraPS.Version object' {
                $version2 = Get-JiraVersion -ID $versionID2
            ...
            It 'moves a Version using Tyler.DevOps.JiraPS.Version object over pipeline and other Version Tyler.DevOps.JiraPS.Version object' {
                $version1 = Get-JiraVersion -ID $versionID1
                $version2 = Get-JiraVersion -ID $versionID2
